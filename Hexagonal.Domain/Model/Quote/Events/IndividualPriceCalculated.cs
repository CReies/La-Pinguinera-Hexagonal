...
public class IndividualPriceCalculated( string? bookTitle, string? bookAuthor, decimal bookBasePrice, BookType bookType, DateOnly customerRegisterDate ) : DomainEvent( EventType.IndividualPriceCalculated.ToString() )
{
